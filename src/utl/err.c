...
vb_err_t *vb_err_new(const int64_t num1, const int64_t num2, const char *const str1, const char *const str2) {
	assert(num1);
	vb_err_t *err = NULL;
...
vb_err_t *vb_err_new_oom(const int64_t num1, const int64_t num2, const char *const str2) {
